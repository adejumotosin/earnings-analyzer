...
def fetch_sec_earnings(ticker, quarters=4):
    ...
    Note: This is a simplified, mock-up function for demo purposes.
    Real SEC scraping requires robust CIK lookup, rate limiting, and XBRL parsing.
    """
    try:
        sample_filings = [
            {
            ...
            },
            {
                ...
                'type': '10-Q',
                'period': 'Q2 2024',
                'revenue': 48_900_000_000,
                'net_income': 11_500_000_000,
                'eps': 1.98,
            ...
            },
            {
                ...
                'type': '10-Q',
                'period': 'Q1 2024',
                'revenue': 47_500_000_000,
                'net_income': 10_900_000_000,
                'eps': 1.85,
                'url': f'https://www.sec.gov/sample/{ticker}-q1-2024'
            },
            {
                'date': '2024-01-31',
                'type': '10-K',
                'period': 'FY 2023',
                'revenue': 185_000_000_000,
                'net_income': 45_000_000_000,
                'eps': 8.50,
                'url': f'https://www.sec.gov/sample/{ticker}-fy-2023'
            }
        ]
        return sample_filings[:quarters]
    except Exception as e:
        st.warning(f"⚠️ SEC filing data fetch failed: {e}")
        return []
...
def fetch_earnings_transcripts(ticker, quarters=2):
    """
    Scrape mock earnings call transcripts.
    This is a simplified, mock-up function.
    """
    try:
        sample_transcripts = [
            {
                ...
                'source': 'SeekingAlpha',
                'ceo_comments': [
                    "We delivered strong results this quarter with revenue growth of 8% year-over-year, driven by robust demand for our new product line.",
                    "Our operational efficiency initiatives are yielding significant results, leading to improved margins.",
                    "We are confident in our ability to navigate the current macroeconomic climate and remain on track to meet our full-year targets."
                ],
                'analyst_questions': [
                    "What are your expectations for margin expansion in the next quarter, and what factors will influence this?",
                    "Can you provide more color on the competitive landscape and how it's affecting your market share?",
                    "Could you detail your capital allocation strategy, particularly regarding R&D and share buybacks?"
                ],
                'key_metrics_discussed': [
                    "User growth rate increased 12% quarter-over-quarter, exceeding our internal projections.",
                    "Gross margins improved to 68%, up from 65% last quarter, reflecting our pricing power.",
                    "Free cash flow generation remains strong at $8.2 billion, providing flexibility for strategic investments."
                ]
            },
            {
                'date': '2024-07-31',
                ...
                'source': 'MotleyFool',
                'ceo_comments': [
                    "Our Q2 performance was solid, demonstrating the resilience of our business model.",
                    "The integration of our recent acquisition is progressing ahead of schedule, unlocking new synergies.",
                    "We are seeing early signs of a rebound in our key international markets."
                ],
                'analyst_questions': [
                    "How is the supply chain environment impacting your production and costs?",
                    "Can you elaborate on the long-term strategic benefits of the recent acquisition?",
                    "What are the primary drivers behind the strong free cash flow generation this quarter?"
                ],
                'key_metrics_discussed': [
                    "New user acquisition grew by 10% compared to the prior quarter.",
                    "Operating expenses were managed effectively, coming in below our forecast.",
                    "Shareholder return was a key focus, with a significant dividend increase announced."
                ]
            }
        ]
        return sample_transcripts[:quarters]
    except Exception as e:
        st.warning(f"⚠️ Transcript data fetch failed: {e}")
        return []
...
def fetch_analyst_sentiment(ticker, days=30):
    """
    Fetch mock analyst reports and news sentiment.
    This is a simplified, mock-up function.
    """
    try:
        sample_reports = [
